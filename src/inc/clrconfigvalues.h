...
CONFIG_STRING_INFO_EX(INTERNAL_JitPrependNops, W("JitPrependNops"), "Prepends nop instructions into jitted code", CLRConfig::REGUTIL_default)
CONFIG_DWORD_INFO_EX(INTERNAL_JitPrependNopsNumber, W("JitPrependNopsNumber"), 0, "Number of nop instructions to prepend", CLRConfig::REGUTIL_default)
